...
interface ServerHeaderProps {
    //cant directly get server from prism as this server also has channels, members etc
    //this server is the new server varaible with all that information we created in server-sidebar.tsx
    //to handle this we need a new type, ServerWithMembersWithProfiles
  server: ServerWithMembersWithProfiles;
  //roe is optional as new members may not have roles
  role?: MemberRole;
};
